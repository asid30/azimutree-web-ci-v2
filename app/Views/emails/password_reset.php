...
<head>
    <meta charset="utf-8">
    <title>Kode Reset Password Azimutree</title>
</head>
<body style="margin:0;background:#f4f7f6;font-family:Arial,sans-serif;color:#0f1724">
    <div style="max-width:520px;margin:0 auto;padding:28px 18px">
        <div style="background:#ffffff;border-radius:10px;padding:24px;border:1px solid #dfe7e3">
            <h2 style="margin:0 0 10px;color:#0f1724">Reset Password Azimutree</h2>
            <p style="margin:0 0 16px;line-height:1.5">Halo <?= esc($username) ?>, gunakan kode OTP berikut untuk mengganti password akun repositori data Anda.</p>
            ...
            <p style="margin:0 0 16px;line-height:1.5;color:#475569">Kode OTP <?= esc($otp) ?> berlaku selama 30 menit.</p>
            <table role="presentation" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto 12px">
                <tr>
                    <td align="center" bgcolor="#34d399" style="border-radius:8px">
                        <a href="<?= esc($resetUrl) ?>" style="display:block;background:#34d399;color:#07221a;text-decoration:none;font-weight:700;border-radius:8px;padding:10px 14px">Buka Halaman Reset</a>
                    </td>
                </tr>
            </table>
